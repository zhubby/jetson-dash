...
class CustomCollector(object):
    ...
    def __cpu(self):
        ...
        for core_number,core_data  in self.jetson.cpu.items():
            cpu_gauge.add_metric([core_number, 'cur_freq'], value=core_data['freq']['cur'])
            cpu_gauge.add_metric([core_number, 'min_freq'], value=core_data['freq']['min']) 
            cpu_gauge.add_metric([core_number, 'max_freq'], value=core_data['freq']['max'])             
        return cpu_gauge
